...
test_RD <- function(x_E, x_C, n_E, n_C, delta){
  ...
  w <- 1/3 * (pi + acos(ifelse(u == 0, 0, round(v/u^3, 10))))   # das round wurde eingebaut, weil wenn bei v/u^3 etwas minimal größer als 1 rauskommt es zu einer Fehlermeldung kommt! 
  # Define the solution
